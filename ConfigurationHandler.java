...
public class ConfigurationHandler
{
	public static void configurationInit(File file)
	{
		...
		DecorativeChimneyCore.blockMantelCenterBlockID = configuration.getBlock("Block", "Mantel Center", 2005).getInt();
//		DecorativeChimneyCore.blockMantelCenterABlockID = configuration.getBlock("Block", "Mantel Center A", 2007).getInt();
		...
		DecorativeChimneyCore.blockChimney3BlockID = configuration.getBlock("Block", "Chimney Style 3", 2013).getInt();

		DecorativeChimneyCore.itemChimney1BlockID = configuration.getItem("Item", "Chimney Style 1", 20010).getInt() - 256;
		DecorativeChimneyCore.itemChimney2BlockID = configuration.getItem("Item", "Chimney Style 2", 20011).getInt() - 256;
		DecorativeChimneyCore.itemChimney3BlockID = configuration.getItem("Item", "Chimney Style 3", 20012).getInt() - 256;
		DecorativeChimneyCore.itemMantelCornerBlockID = configuration.getItem("Item", "Mantel Corner", 20013).getInt() - 256;
		DecorativeChimneyCore.itemMantelCenterBlockID = configuration.getItem("Item", "Mantel Center", 20014).getInt() - 256;
