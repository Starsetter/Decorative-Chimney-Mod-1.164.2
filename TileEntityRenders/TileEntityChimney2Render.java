...
public class TileEntityChimney2Render extends TileEntitySpecialRenderer
{
	...
	public TileEntityChimney2Render()
	{
		model = new ModelChimney2();
	}

	public void renderAModelAt(TileEntityChimney2 tile, double d, double d1, double d2, float f)
	{
		...
		switch (i) // the good part. get's your block multiple textures
		{
			case 0:
				...
				break;
			case 1:
				tileEntityRenderer.renderEngine.bindTexture(new ResourceLocation("decorativechimney:textures/Chimney1W.png"));
				break;
			case 2:
				tileEntityRenderer.renderEngine.bindTexture(new ResourceLocation("decorativechimney:textures/Chimney1W.png"));
				break;
			case 3:
				...
				break;
			case 4:
				tileEntityRenderer.renderEngine.bindTexture(new ResourceLocation("decorativechimney:textures/Chimney1WG.png"));
				break;
			case 5:
				tileEntityRenderer.renderEngine.bindTexture(new ResourceLocation("decorativechimney:textures/Chimney1WG.png"));
				break;
