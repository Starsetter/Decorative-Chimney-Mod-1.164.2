...
import DecorativeChimney.TileEntities.TileEntityChimney2C;


public class TileEntityChimney2CRender extends TileEntitySpecialRenderer
{

	public TileEntityChimney2CRender()
	{
		model = new ModelChimney2();
	}

	public void renderAModelAt(TileEntityChimney2C tile, double d, double d1, double d2, float f)
	{
		...
		{
			case 0:
				tileEntityRenderer.renderEngine.bindTexture(new ResourceLocation("decorativechimney:textures/Chimney1Wo.png")); // bindTextureByName + the path to your image. for the block that you gave damage number 0
				break;
			case 1:
	...
	{
		renderAModelAt((TileEntityChimney2C) tileentity, d, d1, d2, f); //where to render
	}
