...
public class BlockChimney2C extends BlockContainer
{

	public BlockChimney2C(int id, Class class1)
	{
    ...
    private static final String[] blockChimneyBottomNames =
		{ 
    		"WoodPlank", "WoodPlank", "WoodPlank", "WoodPlank", "Emerald", "Emerald", "Emerald", "Emerald", 
    		"Gold", "Gold", "Gold", "Gold", "Diamond", "Diamond", "Diamond", "Diamond", 
		};
	...
	{
		return new TileEntityChimney2C();
	}
