...
public class BlockChimney2B extends BlockContainer
{

	public BlockChimney2B(int id, Class class1)
	{
    ...
    private static final String[] blockChimneyBottomNames =
		{ 
    		...
    		"BlackMarble", "BlackMarble", "BlackMarble", "BlackMarble", "CobbleStone", "CobbleStone", "CobbleStone", "CobbleStone", 
		};
	...
	{
		return new TileEntityChimney2B();
	}
